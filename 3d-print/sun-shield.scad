...
// Mounting pipe/mast diameter (in mm)
MOUNTDIA = 42.25;

// The part(s) to render
Part = 0;		// [0:Preview All,1:Outer Top Cover,2:Inner Top Cover,3:Pipe Mount and Thermometer Holder,4:Shield Ring -- need 4x,5:Bottom Cover]
...
//		}
	...
	for (R = [0+ROTATE : 120 : 360+ROTATE]) {
		rotate([0,0,R]) translate([DIAs/2-DIAi/2-2,0,0]) difference() {
